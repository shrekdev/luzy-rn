...
import {StyleSheet, Modal, Text, View, Image, TouchableOpacity, ScrollView} from 'react-native';
...
class RecipeBook extends Component {
    ...
    recipeDetail = (data) => {
        this.props.navigation.navigate('RecipeDetail', {data});
    };
            ...
            <View style={[container, {paddingBottom: hp('10%') + safeArea.bottom}]}>
                ...
                >
                    <Image source={{uri: 'prepare_your_food_recipes_book_illustration_1'}}
                           ...
                           resizeMode={'stretch'}/>
                    <View>
                        <Text style={header}>RECIPES BOOK</Text>
