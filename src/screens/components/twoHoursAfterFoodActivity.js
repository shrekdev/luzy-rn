...
import {AppButton, BottomTab, DayTab} from "../common";
...
class TwoHoursAfterFoodActivity extends Component {
    ...
    makeAnAppointment = () => {
        this.props.navigation.navigate('Appointment',{from: 'TwoHoursAfterFoodActivity'})
    };
    ...
    */
        ...
        return (
            <View style={{flex: 1}}>
                <ScrollView style={scrollView} showsVerticalScrollIndicator={false}
                    ...
                    <Text style={header}>
                        {'2 HOURS AFTER FOOD ACTIVITY'}</Text>
                    <Text style={subText}>
    ...
    render() {
        ...
        return (
            <View style={{flex: 1, backgroundColor: Constant.color.lightSky}}>
...
export {TwoHoursAfterFoodActivity};
