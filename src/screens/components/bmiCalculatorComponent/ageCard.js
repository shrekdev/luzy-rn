...
class AgeCard extends Component {
    ...
    render() {
        ...
        const {center, detailView, cardTitleText, cardSubtitleText, cardTopView, cardView, rowSpace, wheelView, wheelSeprator, wheelText} = styles;
        return (
            <View style={cardView}>
                <View style={cardTopView}>
                    ...
                    <View style={center}>
                        ...
                        <Text style={cardSubtitleText}>{'SELECT AGE:'}</Text>
                    </View>
                </View>
                <View style={cardTopView}>
