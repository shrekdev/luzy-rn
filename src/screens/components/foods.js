...
import {BaseCard, Card, BottomTab} from "../common";
import {foodCardData} from '../../helper/appConstant';
...
class Foods extends Component {
    ...
    renderCard = (data, index) => {
        ...
        return <Card
            ...
            style={{
                ...
                marginRight: index === foodCardData.length - 1 ? wp('45%') : 0
            }}
    ...
    onIconClick = (from) => {
        ...
        } else if (from === 'next' && this.selectedCard < foodCardData.length - 1) {
            this.scrollview.scrollTo({x: (this.selectedCard + 1) * 210, y: 0, animated: true})
        }
    };
        ...
        return (
            <View style={{...container, paddingBottom: hp('10%') + safeArea.bottom}}>
                <BaseCard
                    ...
                    headerImage={'food_big'}
                    headerText={'FOOD'}
                    headerSubText={'The place where you can find healthy food recepies \n and recommended food and not recommended food.'}
                />
                ...
                <ScrollView
                    ...
                    {
                        foodCardData.map((data, index) => this.renderCard(data, index))
                    }
                </ScrollView>
                ...
                <View style={{
                    ...
                    <View style={{flexDirection: 'row'}}>
                        {foodCardData.map((data, index) => this.renderCardBottom(index))}
                    </View>
