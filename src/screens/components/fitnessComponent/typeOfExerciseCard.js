...
import { typeOfExerciseList } from '../../../helper/appConstant'
import { AppButton } from "../../common";
import { widthPercentageToDP as wp, heightPercentageToDP as hp } from '../../../helper/responsiveScreen';

class TypeOfExerciseCard extends Component {
    ...
    renderListItem = (data, index) => {
        ...
        return <View key={index}>
            <TouchableOpacity style={rowCenter} onPress={() => this.props.onExerciseSelect(data, index)}>
                {
                    this.props.typeOfExerciseArrayTemp.includes(data) &&
        ...
        return (
            <View style={filterView}>
                ...
                <ScrollView showsVerticalScrollIndicator={false} style={{ height: hp('31%'), backgroundColor: Constant.color.white }}
                    ...
                    {
                        typeOfExerciseList.map((data, index) => this.renderListItem(data, index))
                    }
